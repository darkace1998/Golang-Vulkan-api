...
//	    fragColor = inColor * push.colorMul;
//	}
var vertexShaderCode = []uint32{
	...
	0x00000026, 0x00030003, 0x00000002, 0x000001c2, 0x00040005, 0x00000004,
	...
	0x00006e6f, 0x00060005, 0x00000015, 0x68737550, 0x736e6f43, 0x746e6174,
	0x00000073, 0x00050006, 0x00000015, 0x00000000, 0x7366666f, 0x00007465,
	0x00060006, 0x00000015, 0x00000001, 0x6f6c6f63, 0x6c754d72, 0x00000000,
	0x00040005, 0x00000017, 0x68737570, 0x00000000, 0x00050005, 0x00000024,
	0x67617266, 0x6f6c6f43, 0x00000072, 0x00040005, 0x00000026, 0x6f436e69,
	0x00726f6c, 0x00030047, 0x0000000b, 0x00000002, 0x00050048, 0x0000000b,
	...
	0x00040047, 0x00000012, 0x0000001e, 0x00000000, 0x00030047, 0x00000015,
	0x00000002, 0x00050048, 0x00000015, 0x00000000, 0x00000023, 0x00000000,
	0x00050048, 0x00000015, 0x00000001, 0x00000023, 0x00000010, 0x00040047,
	0x00000024, 0x0000001e, 0x00000000, 0x00040047, 0x00000026, 0x0000001e,
	...
	0x00000010, 0x00000006, 0x00000002, 0x00040020, 0x00000011, 0x00000001,
	0x00000010, 0x0004003b, 0x00000011, 0x00000012, 0x00000001, 0x00040017,
	0x00000014, 0x00000006, 0x00000003, 0x0004001e, 0x00000015, 0x00000010,
	0x00000014, 0x00040020, 0x00000016, 0x00000009, 0x00000015, 0x0004003b,
	0x00000016, 0x00000017, 0x00000009, 0x00040020, 0x00000018, 0x00000009,
	0x00000010, 0x0004002b, 0x00000006, 0x0000001c, 0x00000000, 0x0004002b,
	0x00000006, 0x0000001d, 0x3f800000, 0x00040020, 0x00000021, 0x00000003,
	0x00000007, 0x00040020, 0x00000023, 0x00000003, 0x00000014, 0x0004003b,
	0x00000023, 0x00000024, 0x00000003, 0x00040020, 0x00000025, 0x00000001,
	0x00000014, 0x0004003b, 0x00000025, 0x00000026, 0x00000001, 0x0004002b,
	0x0000000e, 0x00000028, 0x00000001, 0x00040020, 0x00000029, 0x00000009,
	...
	0x00050041, 0x00000018, 0x00000019, 0x00000017, 0x0000000f, 0x0004003d,
	0x00000010, 0x0000001a, 0x00000019, 0x00050081, 0x00000010, 0x0000001b,
	0x00000013, 0x0000001a, 0x00050051, 0x00000006, 0x0000001e, 0x0000001b,
	0x00000000, 0x00050051, 0x00000006, 0x0000001f, 0x0000001b, 0x00000001,
	0x00070050, 0x00000007, 0x00000020, 0x0000001e, 0x0000001f, 0x0000001c,
	0x0000001d, 0x00050041, 0x00000021, 0x00000022, 0x0000000d, 0x0000000f,
	0x0003003e, 0x00000022, 0x00000020, 0x0004003d, 0x00000014, 0x00000027,
	0x00000026, 0x00050041, 0x00000029, 0x0000002a, 0x00000017, 0x00000028,
	0x0004003d, 0x00000014, 0x0000002b, 0x0000002a, 0x00050085, 0x00000014,
	0x0000002c, 0x00000027, 0x0000002b, 0x0003003e, 0x00000024, 0x0000002c,
...
func main() {
	fmt.Println("=== Vulkan Push Constants Example ===")
		...
		PushConstants: []vulkan.PushConstantRange{
			{
				...
				Offset:     0,
				Size:       uint32(unsafe.Sizeof(PushConstantsData{})),
			},
		},
	})
	if err != nil {
	...
	fmt.Println("   ✓ Pipeline layout created (with push constants)")
	...
	// Draw three triangles with different offsets and colors using push constants

	// Triangle 1: Left, Reddish
	pc1 := PushConstantsData{
		OffsetX: -0.4, OffsetY: 0.0,
		ColorR: 1.0, ColorG: 0.2, ColorB: 0.2,
	}
	vulkan.CmdPushConstantsTyped(cb, pipelineLayout, vulkan.ShaderStageVertexBit, 0, &pc1)
	vulkan.CmdDraw(cb, uint32(len(triangleVertices)), 1, 0, 0)

	// Triangle 2: Center, Greenish
	pc2 := PushConstantsData{
		OffsetX: 0.0, OffsetY: 0.2,
		ColorR: 0.2, ColorG: 1.0, ColorB: 0.2,
	}
	vulkan.CmdPushConstantsTyped(cb, pipelineLayout, vulkan.ShaderStageVertexBit, 0, &pc2)
	vulkan.CmdDraw(cb, uint32(len(triangleVertices)), 1, 0, 0)

	// Triangle 3: Right, Bluish
	pc3 := PushConstantsData{
		OffsetX: 0.4, OffsetY: -0.2,
		ColorR: 0.2, ColorG: 0.2, ColorB: 1.0,
	}
	vulkan.CmdPushConstantsTyped(cb, pipelineLayout, vulkan.ShaderStageVertexBit, 0, &pc3)
	vulkan.CmdDraw(cb, uint32(len(triangleVertices)), 1, 0, 0)
	...
	// 15. Summary
	// -----------------------------------------------------------------------
	fmt.Println("\n=== Push Constants Example Complete ===")
	fmt.Println()
	...
	fmt.Println("  ✓ CmdPushConstantsTyped (Vertex shader)")
	fmt.Println("  ✓ CmdDraw (non-indexed, multiple draws with push constants)")
	fmt.Println()
